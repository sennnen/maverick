...
| M2 | Mock second device | A deliberately awkward fake device proves the connector abstraction with zero pipeline edits | [active/M2.md](active/M2.md) |
| M3 | RR, HRV, Recovery | Capability negotiation end to end; recovery hidden when RR is absent, proven with the mock | not yet broken into packets |
