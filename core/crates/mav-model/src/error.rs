...
pub mod codes {
    ...
    pub const RETIRED_DECODE_3004: u16 = 3004;
    pub const RETIRED_DECODE_3005: u16 = 3005;
    pub const RETIRED_DECODE_3006: u16 = 3006;
    ...
    pub const CONNECTOR_REGISTRY_OVERSIZED: u16 = 11_052;
    pub const CONNECTOR_REGISTRY_MALFORMED: u16 = 11_053;
    pub const CONNECTOR_REGISTRY_SIGNATURE_INVALID: u16 = 11_054;
    pub const CONNECTOR_REGISTRY_STALE: u16 = 11_055;
    pub const CONNECTOR_REGISTRY_ROLLBACK: u16 = 11_056;
    pub const CONNECTOR_REGISTRY_CHAIN_INVALID: u16 = 11_057;
    ...
    pub const ALL: &[(u16, &str)] = &[
        ...
        (RETIRED_DECODE_3004, "RETIRED_DECODE_3004"),
        (RETIRED_DECODE_3005, "RETIRED_DECODE_3005"),
        (RETIRED_DECODE_3006, "RETIRED_DECODE_3006"),
        (
        ...
        (ML_ECG_CAPTURE_STATE, "ML_ECG_CAPTURE_STATE"),
        (ML_ECG_INFERENCE_INVALID, "ML_ECG_INFERENCE_INVALID"),
        (ML_ECG_PREPROCESSING, "ML_ECG_PREPROCESSING"),
        ...
        (CONNECTOR_REGISTRY_OVERSIZED, "CONNECTOR_REGISTRY_OVERSIZED"),
        (CONNECTOR_REGISTRY_MALFORMED, "CONNECTOR_REGISTRY_MALFORMED"),
        (
            CONNECTOR_REGISTRY_SIGNATURE_INVALID,
            "CONNECTOR_REGISTRY_SIGNATURE_INVALID",
        ),
        (CONNECTOR_REGISTRY_STALE, "CONNECTOR_REGISTRY_STALE"),
        (CONNECTOR_REGISTRY_ROLLBACK, "CONNECTOR_REGISTRY_ROLLBACK"),
        (
            CONNECTOR_REGISTRY_CHAIN_INVALID,
            "CONNECTOR_REGISTRY_CHAIN_INVALID",
        ),
        (
            CONNECTOR_REGISTRY_ROTATION_INVALID,
            "CONNECTOR_REGISTRY_ROTATION_INVALID",
        ),
        (
            CONNECTOR_REGISTRY_ARTIFACT_MISMATCH,
            "CONNECTOR_REGISTRY_ARTIFACT_MISMATCH",
        ),
        (
            CONNECTOR_REGISTRY_UPDATE_REJECTED,
            "CONNECTOR_REGISTRY_UPDATE_REJECTED",
        ),
